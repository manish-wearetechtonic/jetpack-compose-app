...
@Composable
fun BottomNavigation( authViewModel: AuthViewModel = viewModel()) {
...
fun NavigationHost(navController: NavHostController) {
    NavHost(navController = navController, startDestination = Screens.ScreensHomeRoute.route) {
        ...
        composable(Screens.ScreensSettingsRoute.route) { SettingsScreen(navController = navController) }
        composable(Screens.ScreensLandingPageRoute.route) { LandingPage(navController = navController) }
        composable(Screens.ScreensLoginRoute.route) { LoginScreen(navController = navController) }
    }
}
